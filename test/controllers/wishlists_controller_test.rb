...
class WishlistsControllerTest < ActionController::TestCase
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post :create, wishlist: { category_id: @wishlist.category_id, insert_date: @wishlist.insert_date, product_id: @wishlist.product_id, user_id: @wishlist.user_id }
    end
  ...
  test "should update wishlist" do
    patch :update, id: @wishlist, wishlist: { category_id: @wishlist.category_id, insert_date: @wishlist.insert_date, product_id: @wishlist.product_id, user_id: @wishlist.user_id }
    assert_redirected_to wishlist_path(assigns(:wishlist))
  end
